...
public class GameSettingTable extends Table {
    ...
    public void update() {
        ...
        setValue("keyBindUse", new Variable(new KeybindTable(settings.keyBindUseItem)));
        setValue("ofKeyBindZoom", new Variable(new KeybindTable(settings.ofKeyBindZoom)));
        setValue("keyBindTogglePerspective", new Variable(new KeybindTable(settings.keyBindTogglePerspective)));
        setValue("keyBindSpectatorOutlines", new Variable(new KeybindTable(settings.keyBindSpectatorOutlines)));
        setValue("keyBindStreamCommercials", new Variable(new KeybindTable(settings.keyBindStreamCommercials)));
        setValue("keyBindStreamPauseUnpause", new Variable(new KeybindTable(settings.keyBindStreamPauseUnpause)));
        setValue("keyBindStreamStartStop", new Variable(new KeybindTable(settings.keyBindStreamStartStop)));
